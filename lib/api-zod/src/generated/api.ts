...
export const ExplainStudyTopicBody = zod.object({
  "prompt": zod.string(),
  "model": zod.enum(['gemini-3.1-flash-lite', 'gemini-3.7-flash', 'gemini-3.1-pro', 'gpt-5.6-luna', 'gpt-5.6-terra', 'gpt-5.6-sol', 'claude-haiku-4-5', 'claude-sonnet-5', 'claude-opus-5', 'claude-fable-5-1']).optional(),
